...
export const mockBatches = [
  {
    ...
    status: 'ongoing',
    students: [
      { id: 's1', name: 'Rahul Kumar', admissionNo: 'STU-001', enrolledDate: '2024-01-05' },
      { id: 's2', name: 'Priya Sharma', admissionNo: 'STU-002', enrolledDate: '2024-01-05' },
      { id: 's3', name: 'Amit Patel', admissionNo: 'STU-003', enrolledDate: '2024-01-08' },
      { id: 's4', name: 'Neha Singh', admissionNo: 'STU-004', enrolledDate: '2024-01-10' },
      { id: 's5', name: 'Vikram Reddy', admissionNo: 'STU-005', enrolledDate: '2024-01-12' },
    ],
  },
  {
    id: 'b2',
    ...
    teacherIds: ['t2'],
    schedule: 'Tue, Thu: 11:00 - 12:30 | Sat: 10:00 - 11:30',
    schedules: [
      {
        id: 'slot-1',
        days: ['Tue', 'Thu'],
    ...
    status: 'ongoing',
    students: [
      { id: 's6', name: 'Ananya Gupta', admissionNo: 'STU-006', enrolledDate: '2024-01-03' },
      { id: 's7', name: 'Rohan Mehta', admissionNo: 'STU-007', enrolledDate: '2024-01-03' },
      { id: 's8', name: 'Kavya Iyer', admissionNo: 'STU-008', enrolledDate: '2024-01-06' },
    ],
  },
  {
    id: 'b3',
    ...
    status: 'ongoing',
    students: [
      { id: 's9', name: 'Sanjay Kumar', admissionNo: 'STU-009', enrolledDate: '2024-01-04' },
      { id: 's10', name: 'Divya Nair', admissionNo: 'STU-010', enrolledDate: '2024-01-07' },
    ],
  },
];
